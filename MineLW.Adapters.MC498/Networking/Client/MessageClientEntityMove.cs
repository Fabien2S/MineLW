...
{
    public class MessageClientEntityMove : MessageSerializer<MessageClientEntityMove.Message>
    {
        ...
        public struct Message : IMessage
        {
            ...
            public Message(int id, short deltaX, short deltaY, short deltaZ, bool grounded)
            {
                Id = id;
                DeltaX = deltaX;
                DeltaY = deltaY;
